<!-- Generated from library/write-technical-spec/SKILL.md; do not edit. -->
...
7. List unresolved decisions with owners or the evidence needed to resolve them.

Use normative language consistently and make each requirement independently testable. Do not hide uncertainty behind invented precision.
