...
4. Add or update tests at the most faithful stable seam.
...
Report changed behavior, key design decisions, commands run, and remaining risk. Do not claim completion when acceptance criteria remain unverified.
