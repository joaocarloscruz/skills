<!-- Generated from library/write-documentation/SKILL.md; do not edit. -->

# Write Documentation

1. Identify the reader, task, prerequisites, supported versions, and document type.
2. Verify behavior against current code, commands, configuration, or authoritative documentation.
